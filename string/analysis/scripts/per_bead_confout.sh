...
gmx trjconv -f $trajext/$trajdir/md/$i/$bead/restrained/confout.gro -o ../confout_files/pdb_clips/$trajdir.bead_$bead.iteration_$i.pdb -n $trajext/$trajdir/topology/index.ndx -pbc whole -s $trajext/$trajdir/md/$i/$bead/restrained/topol.tpr << EOF
0
0
0
EOF
